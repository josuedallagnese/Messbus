...
public class EmulatorAccountTests : IClassFixture<EmulatorAccountFixture>
{
    private readonly EmulatorAccountFixture _fixture;

    public EmulatorAccountTests(EmulatorAccountFixture fixture)
    {
        _fixture = fixture;
    }
