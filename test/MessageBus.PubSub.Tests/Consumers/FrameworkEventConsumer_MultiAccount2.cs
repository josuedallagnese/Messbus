...
public class FrameworkEventConsumer_MultiAccount2 : IMessageConsumer<FrameworkEvent>
{
    private readonly ConsumerCollector<FrameworkEvent, FrameworkEventConsumer_MultiAccount2> _consumerCollector;

    public FrameworkEventConsumer_MultiAccount2(ConsumerCollector<FrameworkEvent, FrameworkEventConsumer_MultiAccount2> consumerCollector)
    {
